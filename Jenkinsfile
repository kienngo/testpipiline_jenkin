pipeline {
    ...
    stages {
        stage('Build') { 
            steps {
				bat 'dotnet nuget add source https://pkgs.dev.azure.com/PJC-Dev-Organization/PJC-Dev-Prj/_packaging/PJC-Dev-Artifacts/nuget/v3/index.json -u ngo.duc.kien@vhec.vn -p Kien@1996 -h'
